...
(cond
 ...
 ((string-equal system-type "gnu/linux") ; linux
  (progn
    (setq save-to-clipboard-cmd "wl-copy")
    (setq paste-from-clipboard-cmd "wl-paste")
    )
  )
 )
...
(defun copy-to-clipboard ()
  ...
  (if (display-graphic-p)
      (progn
        (message "Yanked region to wl-clipboard!")
...
(setq org-gcal-client-id "65441525054-8q8q2dpo9tcrq8kg9cmfmd979f040917.apps.googleusercontent.com"
      org-gcal-client-secret "fKmY7xbTa6MOTxgc2HWS_Zn0"
       org-gcal-file-alist '(("olenik.gregor@gmail.com" .  "~/gtd/WorkGcal.org")
                             ("0a86mfhevbmuagetp2tt85rg7c@group.calendar.google.com" .  "~/gtd/MoKiZaeGcal.org")
                             ("tsdpdam1psd3ngdn3ai4goie60@group.calendar.google.com" .  "~/gtd/HomeGcal.org")
                             )
       )

;; projectile
(setq projectile-project-search-path '("~/Dropbox/gtd/" "~/data/code/"))
